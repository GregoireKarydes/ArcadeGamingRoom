...
document.getElementById('round').innerHTML= "Round " + localStorage.scoreNeed;
...
function resetBall(){
    if(user.score == localStorage.scoreNeed){
        window.location.href="../flappy/index.html";
    }

    if(com.score==1){
        window.location.href="../score/score.php";
        localStorage.yourScore = localStorage.scoreNeed;
        localStorage.scoreNeed =1;
    }
    ball.x = cvs.width/2;
    ball.y = cvs.height/2;
